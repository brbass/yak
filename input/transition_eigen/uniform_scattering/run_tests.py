...
distance_values = np.around(np.arange(0.05, 0.25, 0.05), decimals=2)
...
def run_problem(index):
    test_description = "\tInd: {2} / {3}\tDist: {0}\tShape: {1}".format(output_values[index][1], output_values[index][0], index + 1, number_of_cases)
